...
[Icons]
Name: "{group}\MdViewer"; Filename: "{app}\MdViewer.exe"
Name: "{group}\卸载 MdViewer"; Filename: "{uninstallexe}"
Name: "{autodesktop}\MdViewer"; Filename: "{app}\MdViewer.exe"; Tasks: desktopicon
